...
#
# Generated Mon Jan 23 00:15:53 2023 by generateDS.py version 2.41.1.
...
import src.exlap.exlap_v2 as supermod
...
class AuthenticateSub(supermod.Authenticate):
    def __init__(self, phase=None, user='', cnonce='', digest='', useHash='', **kwargs_):
        super(AuthenticateSub, self).__init__(phase, user, cnonce, digest, useHash,  **kwargs_)
...
class AbsoluteSub(supermod.Absolute):
    def __init__(self, name=None, required=True, unit=None, min=-INF, max=INF, resolution=0, **kwargs_):
