...
#
# Generated Mon Jan 23 00:15:52 2023 by generateDS.py version 2.41.1.
...
#
# Command line:
#   /opt/homebrew/bin/generateDS.py -s "exlapv2_subs.py" --member-specs="dict" -m --enable-slots --export="write literal etree" -o "exlap_v2.py" schema/protocol.xsd
#
...
class Exlap(GeneratedsSuper):
    ...
    member_data_items_ = {
        'Req': MemberSpec_('Req', 'Req', 1, 0, {'name': 'Req', 'ref': 'Req', 'type': 'Req'}, 1),
        'Status': MemberSpec_('Status', 'Status', 1, 0, {'name': 'Status', 'ref': 'Status', 'type': 'Status'}, 1),
        'Rsp': MemberSpec_('Rsp', 'Rsp', 1, 0, {'name': 'Rsp', 'ref': 'Rsp', 'type': 'Rsp'}, 1),
        'Dat': MemberSpec_('Dat', 'Dat', 1, 0, {'name': 'Dat', 'ref': 'Dat', 'type': 'Dat'}, 1),
    }
    ...
    ReqProp = property(get_Req, set_Req)
    def get_Status(self):
        return self.Status
    ...
    RspProp = property(get_Rsp, set_Rsp)
    def get_Dat(self):
        return self.Dat
    ...
    DatProp = property(get_Dat, set_Dat)
    ...
    def to_etree(self, parent_element=None, name_='Exlap', mapping_=None, reverse_mapping_=None, nsmap_=None):
        if parent_element is None:
            element = etree_.Element('{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        else:
            element = etree_.SubElement(parent_element, '{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        for Req_ in self.Req:
            Req_.to_etree(element, name_='Req', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        for Status_ in self.Status:
            Status_.to_etree(element, name_='Status', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        for Rsp_ in self.Rsp:
            Rsp_.to_etree(element, name_='Rsp', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        for Dat_ in self.Dat:
            Dat_.to_etree(element, name_='Dat', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        if mapping_ is not None:
            mapping_[id(self)] = element
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
        return element
    def exportLiteral(self, outfile, level, name_='Exlap'):
        level += 1
        already_processed = set()
    ...
    def _exportLiteralChildren(self, outfile, level, name_):
        ...
        for Req_ in self.Req:
            showIndent(outfile, level)
            outfile.write('model_.Req(\n')
            Req_.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        ...
        for Rsp_ in self.Rsp:
            showIndent(outfile, level)
            outfile.write('model_.Rsp(\n')
            Rsp_.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        ...
        for Dat_ in self.Dat:
            showIndent(outfile, level)
            outfile.write('model_.Dat(\n')
            Dat_.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class Status(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'msg': MemberSpec_('msg', 'xs:string', 0, 1, {'use': 'optional', 'name': 'msg'}),
        'Init': MemberSpec_('Init', 'InitType', 0, 0, {'name': 'Init', 'type': 'InitType'}, 2),
        'Bye': MemberSpec_('Bye', 'Bye', 0, 0, {'name': 'Bye', 'type': 'ByeType'}, 2),
        'Dataloss': MemberSpec_('Dataloss', 'DatalossType', 0, 0, {'name': 'Dataloss', 'type': 'DatalossType'}, 2),
        'Alive': MemberSpec_('Alive', 'Alive', 0, 0, {'name': 'Alive', 'type': 'AliveType'}, 2),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = None
    ...
    def set_Init(self, Init):
        self.Init = Init
    InitProp = property(get_Init, set_Init)
    def get_Bye(self):
        return self.Bye
    def set_Bye(self, Bye):
        self.Bye = Bye
    ByeProp = property(get_Bye, set_Bye)
    def get_Dataloss(self):
        return self.Dataloss
    def set_Dataloss(self, Dataloss):
        self.Dataloss = Dataloss
    DatalossProp = property(get_Dataloss, set_Dataloss)
    def get_Alive(self):
        return self.Alive
    def set_Alive(self, Alive):
        self.Alive = Alive
    AliveProp = property(get_Alive, set_Alive)
    def get_msg(self):
        return self.msg
    def set_msg(self, msg):
        self.msg = msg
    msgProp = property(get_msg, set_msg)
    def _hasContent(self):
        if (
    ...
    def to_etree(self, parent_element=None, name_='Status', mapping_=None, reverse_mapping_=None, nsmap_=None):
        ...
        if self.msg is not None:
            element.set('msg', self.gds_format_string(self.msg))
        if self.Init is not None:
            Init_ = self.Init
            Init_.to_etree(element, name_='Init', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        if self.Bye is not None:
            Bye_ = self.Bye
            Bye_.to_etree(element, name_='Bye', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        if self.Dataloss is not None:
            Dataloss_ = self.Dataloss
            Dataloss_.to_etree(element, name_='Dataloss', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        if self.Alive is not None:
            Alive_ = self.Alive
            Alive_.to_etree(element, name_='Alive', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        if mapping_ is not None:
            mapping_[id(self)] = element
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
    ...
    def _exportLiteralChildren(self, outfile, level, name_):
        if self.Init is not None:
            showIndent(outfile, level)
            outfile.write('Init=model_.InitType(\n')
            self.Init.exportLiteral(outfile, level, name_='Init')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Bye is not None:
            showIndent(outfile, level)
            outfile.write('Bye=model_.ByeType(\n')
            self.Bye.exportLiteral(outfile, level, name_='Bye')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Dataloss is not None:
            showIndent(outfile, level)
            outfile.write('Dataloss=model_.DatalossType(\n')
            self.Dataloss.exportLiteral(outfile, level, name_='Dataloss')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Alive is not None:
            showIndent(outfile, level)
            outfile.write('Alive=model_.AliveType(\n')
            self.Alive.exportLiteral(outfile, level, name_='Alive')
            showIndent(outfile, level)
            outfile.write('),\n')
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
...
class Req(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'id': MemberSpec_('id', 'idType', 0, 1, {'use': 'optional', 'name': 'id'}),
        'Protocol': MemberSpec_('Protocol', 'Protocol', 0, 0, {'name': 'Protocol', 'ref': 'Protocol', 'type': 'Protocol'}, 3),
        'Dir': MemberSpec_('Dir', 'Dir', 0, 0, {'name': 'Dir', 'ref': 'Dir', 'type': 'Dir'}, 3),
        'Subscribe': MemberSpec_('Subscribe', 'Subscribe', 0, 0, {'name': 'Subscribe', 'ref': 'Subscribe', 'type': 'Subscribe'}, 3),
        'Unsubscribe': MemberSpec_('Unsubscribe', 'Unsubscribe', 0, 0, {'name': 'Unsubscribe', 'ref': 'Unsubscribe', 'type': 'Unsubscribe'}, 3),
        'Call': MemberSpec_('Call', 'Call', 0, 0, {'name': 'Call', 'ref': 'Call', 'type': 'Call'}, 3),
        'Get': MemberSpec_('Get', 'Get', 0, 0, {'name': 'Get', 'ref': 'Get', 'type': 'Get'}, 3),
        'Bye': MemberSpec_('Bye', 'Bye', 0, 0, {'name': 'Bye', 'ref': 'Bye', 'type': 'Bye'}, 3),
        'Alive': MemberSpec_('Alive', 'Alive', 0, 0, {'name': 'Alive', 'ref': 'Alive', 'type': 'Alive'}, 3),
        'Heartbeat': MemberSpec_('Heartbeat', 'Heartbeat', 0, 0, {'name': 'Heartbeat', 'ref': 'Heartbeat', 'type': 'Heartbeat'}, 3),
        'Interface': MemberSpec_('Interface', 'Interface', 0, 0, {'name': 'Interface', 'ref': 'Interface', 'type': 'Interface'}, 3),
        'Authenticate': MemberSpec_('Authenticate', 'Authenticate', 0, 0, {'name': 'Authenticate', 'ref': 'Authenticate', 'type': 'Authenticate'}, 3),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = None
    ...
    def set_Dir(self, Dir):
        self.Dir = Dir
    DirProp = property(get_Dir, set_Dir)
    def get_Subscribe(self):
        return self.Subscribe
    def set_Subscribe(self, Subscribe):
        self.Subscribe = Subscribe
    SubscribeProp = property(get_Subscribe, set_Subscribe)
    def get_Unsubscribe(self):
        return self.Unsubscribe
    def set_Unsubscribe(self, Unsubscribe):
        self.Unsubscribe = Unsubscribe
    UnsubscribeProp = property(get_Unsubscribe, set_Unsubscribe)
    def get_Call(self):
        return self.Call
    ...
    def set_Get(self, Get):
        self.Get = Get
    GetProp = property(get_Get, set_Get)
    def get_Bye(self):
        return self.Bye
    def set_Bye(self, Bye):
        self.Bye = Bye
    ...
    def set_Heartbeat(self, Heartbeat):
        self.Heartbeat = Heartbeat
    HeartbeatProp = property(get_Heartbeat, set_Heartbeat)
    ...
    def set_Authenticate(self, Authenticate):
        self.Authenticate = Authenticate
    AuthenticateProp = property(get_Authenticate, set_Authenticate)
    def get_id(self):
        return self.id
    def set_id(self, id):
        self.id = id
    ...
    def to_etree(self, parent_element=None, name_='Req', mapping_=None, reverse_mapping_=None, nsmap_=None):
        if parent_element is None:
            element = etree_.Element('{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        else:
            element = etree_.SubElement(parent_element, '{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        ...
        if self.Protocol is not None:
            ...
            Protocol_.to_etree(element, name_='Protocol', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        if self.Dir is not None:
            Dir_ = self.Dir
            Dir_.to_etree(element, name_='Dir', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        if self.Subscribe is not None:
            Subscribe_ = self.Subscribe
            Subscribe_.to_etree(element, name_='Subscribe', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        if self.Unsubscribe is not None:
            Unsubscribe_ = self.Unsubscribe
            Unsubscribe_.to_etree(element, name_='Unsubscribe', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        if self.Call is not None:
            Call_ = self.Call
            Call_.to_etree(element, name_='Call', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        if self.Get is not None:
            Get_ = self.Get
            Get_.to_etree(element, name_='Get', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        if self.Bye is not None:
            Bye_ = self.Bye
            Bye_.to_etree(element, name_='Bye', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        if self.Alive is not None:
            ...
            Alive_.to_etree(element, name_='Alive', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        if self.Heartbeat is not None:
            Heartbeat_ = self.Heartbeat
            Heartbeat_.to_etree(element, name_='Heartbeat', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        if self.Interface is not None:
            Interface_ = self.Interface
            Interface_.to_etree(element, name_='Interface', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        if self.Authenticate is not None:
            Authenticate_ = self.Authenticate
            Authenticate_.to_etree(element, name_='Authenticate', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        if mapping_ is not None:
            mapping_[id(self)] = element
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
        return element
    def exportLiteral(self, outfile, level, name_='Req'):
        level += 1
        already_processed = set()
        self._exportLiteralAttributes(outfile, level, already_processed, name_)
        if self._hasContent():
    ...
    def _exportLiteralChildren(self, outfile, level, name_):
        if self.Protocol is not None:
            showIndent(outfile, level)
            outfile.write('Protocol=model_.Protocol(\n')
            self.Protocol.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Dir is not None:
            showIndent(outfile, level)
            outfile.write('Dir=model_.Dir(\n')
            self.Dir.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Subscribe is not None:
            showIndent(outfile, level)
            outfile.write('Subscribe=model_.Subscribe(\n')
            self.Subscribe.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Unsubscribe is not None:
            showIndent(outfile, level)
            outfile.write('Unsubscribe=model_.Unsubscribe(\n')
            self.Unsubscribe.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Call is not None:
            showIndent(outfile, level)
        ...
        if self.Bye is not None:
            showIndent(outfile, level)
            outfile.write('Bye=model_.Bye(\n')
            self.Bye.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Alive is not None:
            showIndent(outfile, level)
            outfile.write('Alive=model_.Alive(\n')
            self.Alive.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Heartbeat is not None:
            showIndent(outfile, level)
            outfile.write('Heartbeat=model_.Heartbeat(\n')
            self.Heartbeat.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Interface is not None:
            showIndent(outfile, level)
            outfile.write('Interface=model_.Interface(\n')
            self.Interface.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Authenticate is not None:
            showIndent(outfile, level)
            outfile.write('Authenticate=model_.Authenticate(\n')
            self.Authenticate.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
...
class Interface(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'url': MemberSpec_('url', 'nameType', 0, 0, {'use': 'required', 'name': 'url'}),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = None
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='Interface', fromsubclass_=False, pretty_print=True):
        pass
    def to_etree(self, parent_element=None, name_='Interface', mapping_=None, reverse_mapping_=None, nsmap_=None):
        if parent_element is None:
            element = etree_.Element('{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        else:
            element = etree_.SubElement(parent_element, '{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
...
class Protocol(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'version': MemberSpec_('version', 'xs:positiveInteger', 0, 0, {'use': 'required', 'name': 'version'}),
        'returnCapabilities': MemberSpec_('returnCapabilities', 'xs:boolean', 0, 1, {'use': 'optional', 'name': 'returnCapabilities'}),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = None
    ...
    returnCapabilitiesProp = property(get_returnCapabilities, set_returnCapabilities)
    def _hasContent(self):
        if (
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='Protocol', fromsubclass_=False, pretty_print=True):
        pass
    def to_etree(self, parent_element=None, name_='Protocol', mapping_=None, reverse_mapping_=None, nsmap_=None):
        if parent_element is None:
            element = etree_.Element('{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        else:
            element = etree_.SubElement(parent_element, '{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        if self.version is not None:
            element.set('version', self.gds_format_integer(self.version))
        if self.returnCapabilities is not None:
            element.set('returnCapabilities', self.gds_format_boolean(self.returnCapabilities))
        if mapping_ is not None:
            mapping_[id(self)] = element
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
    ...
    def _exportLiteralAttributes(self, outfile, level, already_processed, name_):
        ...
        if self.returnCapabilities is not None and 'returnCapabilities' not in already_processed:
            already_processed.add('returnCapabilities')
            showIndent(outfile, level)
            outfile.write('returnCapabilities=%s,\n' % (self.returnCapabilities,))
    def _exportLiteralChildren(self, outfile, level, name_):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
...
class Get(GeneratedsSuper):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='Get', fromsubclass_=False, pretty_print=True):
        pass
    def to_etree(self, parent_element=None, name_='Get', mapping_=None, reverse_mapping_=None, nsmap_=None):
        if parent_element is None:
            element = etree_.Element('{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        else:
            element = etree_.SubElement(parent_element, '{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
...
class Alive(GeneratedsSuper):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='Alive', fromsubclass_=False, pretty_print=True):
        pass
    def to_etree(self, parent_element=None, name_='Alive', mapping_=None, reverse_mapping_=None, nsmap_=None):
        if parent_element is None:
            element = etree_.Element('{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        else:
            element = etree_.SubElement(parent_element, '{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        ...
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
        return element
    def exportLiteral(self, outfile, level, name_='Alive'):
        level += 1
        already_processed = set()
        self._exportLiteralAttributes(outfile, level, already_processed, name_)
        if self._hasContent():
...
class Heartbeat(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'ival': MemberSpec_('ival', 'ivalType', 0, 0, {'use': 'required', 'name': 'ival'}),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = None
    ...
    def set_ival(self, ival):
        self.ival = ival
    ivalProp = property(get_ival, set_ival)
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='Heartbeat', fromsubclass_=False, pretty_print=True):
        pass
    def to_etree(self, parent_element=None, name_='Heartbeat', mapping_=None, reverse_mapping_=None, nsmap_=None):
        if parent_element is None:
            element = etree_.Element('{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        else:
            element = etree_.SubElement(parent_element, '{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        if self.ival is not None:
            element.set('ival', self.gds_format_integer(self.ival))
        if mapping_ is not None:
            mapping_[id(self)] = element
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
        return element
    def exportLiteral(self, outfile, level, name_='Heartbeat'):
        level += 1
        already_processed = set()
        self._exportLiteralAttributes(outfile, level, already_processed, name_)
        if self._hasContent():
...
class Bye(GeneratedsSuper):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='Bye', fromsubclass_=False, pretty_print=True):
        pass
    def to_etree(self, parent_element=None, name_='Bye', mapping_=None, reverse_mapping_=None, nsmap_=None):
        if parent_element is None:
            element = etree_.Element('{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        else:
            element = etree_.SubElement(parent_element, '{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        ...
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
        return element
    def exportLiteral(self, outfile, level, name_='Bye'):
        level += 1
        already_processed = set()
        self._exportLiteralAttributes(outfile, level, already_processed, name_)
        if self._hasContent():
...
class Subscribe(GeneratedsSuper):
    ...
    member_data_items_ = {
        'url': MemberSpec_('url', 'nameType', 0, 0, {'use': 'required', 'name': 'url'}),
        'ival': MemberSpec_('ival', 'ivalType1', 0, 1, {'use': 'optional', 'name': 'ival'}),
        'content': MemberSpec_('content', 'xs:boolean', 0, 1, {'use': 'optional', 'name': 'content'}),
        'timeStamp': MemberSpec_('timeStamp', 'timeStampType', 0, 1, {'use': 'optional', 'name': 'timeStamp'}),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = None
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='Subscribe', fromsubclass_=False, pretty_print=True):
        pass
    def to_etree(self, parent_element=None, name_='Subscribe', mapping_=None, reverse_mapping_=None, nsmap_=None):
        if parent_element is None:
            element = etree_.Element('{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        else:
            element = etree_.SubElement(parent_element, '{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        ...
        if self.content is not None:
            element.set('content', self.gds_format_boolean(self.content))
        if self.timeStamp is not None:
            element.set('timeStamp', self.gds_format_string(self.timeStamp))
        if mapping_ is not None:
            mapping_[id(self)] = element
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
        return element
    def exportLiteral(self, outfile, level, name_='Subscribe'):
        level += 1
        already_processed = set()
        self._exportLiteralAttributes(outfile, level, already_processed, name_)
        if self._hasContent():
...
class Authenticate(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'phase': MemberSpec_('phase', 'phaseType', 0, 0, {'use': 'required', 'name': 'phase'}),
        'user': MemberSpec_('user', 'xs:string', 0, 1, {'use': 'optional', 'name': 'user'}),
        'cnonce': MemberSpec_('cnonce', 'xs:base64Binary', 0, 1, {'use': 'optional', 'name': 'cnonce'}),
        'digest': MemberSpec_('digest', 'xs:base64Binary', 0, 1, {'use': 'optional', 'name': 'digest'}),
        'useHash': MemberSpec_('useHash', 'xs:string', 0, 1, {'use': 'optional', 'name': 'useHash'}),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = None
    def __init__(self, phase=None, user='', cnonce='', digest='', useHash='', gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.useHash = _cast(None, useHash)
        self.useHash_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def set_phase(self, phase):
        self.phase = phase
    phaseProp = property(get_phase, set_phase)
    def get_user(self):
        return self.user
    ...
    def set_cnonce(self, cnonce):
        self.cnonce = cnonce
    cnonceProp = property(get_cnonce, set_cnonce)
    def get_digest(self):
        return self.digest
    def set_digest(self, digest):
        self.digest = digest
    digestProp = property(get_digest, set_digest)
    def get_useHash(self):
        return self.useHash
    def set_useHash(self, useHash):
        self.useHash = useHash
    useHashProp = property(get_useHash, set_useHash)
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='Authenticate'):
        ...
        if self.useHash != "" and 'useHash' not in already_processed:
            already_processed.add('useHash')
            outfile.write(' useHash=%s' % (quote_attrib(self.useHash), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='Authenticate', fromsubclass_=False, pretty_print=True):
        pass
    def to_etree(self, parent_element=None, name_='Authenticate', mapping_=None, reverse_mapping_=None, nsmap_=None):
        if parent_element is None:
            element = etree_.Element('{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        else:
            element = etree_.SubElement(parent_element, '{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        if self.phase is not None:
            element.set('phase', self.gds_format_string(self.phase))
        if self.user is not None:
            element.set('user', self.gds_format_string(self.user))
        if self.cnonce is not None:
            element.set('cnonce', self.cnonce)
        if self.digest is not None:
            element.set('digest', self.digest)
        if self.useHash is not None:
            element.set('useHash', self.useHash)
        if mapping_ is not None:
            mapping_[id(self)] = element
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
        return element
    def exportLiteral(self, outfile, level, name_='Authenticate'):
        level += 1
        already_processed = set()
        self._exportLiteralAttributes(outfile, level, already_processed, name_)
        if self._hasContent():
    ...
    def _exportLiteralAttributes(self, outfile, level, already_processed, name_):
        ...
        if self.cnonce is not None and 'cnonce' not in already_processed:
            already_processed.add('cnonce')
            showIndent(outfile, level)
            outfile.write('cnonce=%s,\n' % (self.cnonce,))
        if self.digest is not None and 'digest' not in already_processed:
            already_processed.add('digest')
            showIndent(outfile, level)
            outfile.write('digest=%s,\n' % (self.digest,))
        if self.useHash is not None and 'useHash' not in already_processed:
            already_processed.add('useHash')
            showIndent(outfile, level)
            outfile.write('useHash=%s,\n' % (self.useHash,))
    def _exportLiteralChildren(self, outfile, level, name_):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'digest' not in already_processed:
            already_processed.add('digest')
            self.digest = value
        value = find_attr_value_('useHash', node)
        if value is not None and 'useHash' not in already_processed:
            already_processed.add('useHash')
            self.useHash = value
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        pass
...
class Unsubscribe(GeneratedsSuper):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='Unsubscribe', fromsubclass_=False, pretty_print=True):
        pass
    def to_etree(self, parent_element=None, name_='Unsubscribe', mapping_=None, reverse_mapping_=None, nsmap_=None):
        if parent_element is None:
            element = etree_.Element('{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        else:
            element = etree_.SubElement(parent_element, '{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        ...
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
        return element
    def exportLiteral(self, outfile, level, name_='Unsubscribe'):
        level += 1
        already_processed = set()
        self._exportLiteralAttributes(outfile, level, already_processed, name_)
        if self._hasContent():
...
class Dir(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'urlPattern': MemberSpec_('urlPattern', 'urlPatternType', 0, 1, {'use': 'optional', 'name': 'urlPattern'}),
        'fromEntry': MemberSpec_('fromEntry', 'xs:positiveInteger', 0, 1, {'use': 'optional', 'name': 'fromEntry'}),
        'numOfEntries': MemberSpec_('numOfEntries', 'xs:positiveInteger', 0, 1, {'use': 'optional', 'name': 'numOfEntries'}),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = None
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='Dir', fromsubclass_=False, pretty_print=True):
        pass
    def to_etree(self, parent_element=None, name_='Dir', mapping_=None, reverse_mapping_=None, nsmap_=None):
        if parent_element is None:
            element = etree_.Element('{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        else:
            element = etree_.SubElement(parent_element, '{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        if self.urlPattern is not None:
            element.set('urlPattern', self.gds_format_string(self.urlPattern))
        if self.fromEntry is not None:
            element.set('fromEntry', self.gds_format_integer(self.fromEntry))
        if self.numOfEntries is not None:
            element.set('numOfEntries', self.gds_format_integer(self.numOfEntries))
        if mapping_ is not None:
            mapping_[id(self)] = element
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
        return element
    def exportLiteral(self, outfile, level, name_='Dir'):
        level += 1
        already_processed = set()
        self._exportLiteralAttributes(outfile, level, already_processed, name_)
        if self._hasContent():
    ...
    def _exportLiteralAttributes(self, outfile, level, already_processed, name_):
        ...
        if self.fromEntry is not None and 'fromEntry' not in already_processed:
            already_processed.add('fromEntry')
            showIndent(outfile, level)
            outfile.write('fromEntry=%d,\n' % (self.fromEntry,))
        if self.numOfEntries is not None and 'numOfEntries' not in already_processed:
            already_processed.add('numOfEntries')
            showIndent(outfile, level)
            outfile.write('numOfEntries=%d,\n' % (self.numOfEntries,))
    def _exportLiteralChildren(self, outfile, level, name_):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
...
class Rsp(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'id': MemberSpec_('id', 'idType2', 0, 1, {'use': 'optional', 'name': 'id'}),
        'status': MemberSpec_('status', 'statusType', 0, 1, {'use': 'optional', 'name': 'status'}),
        'msg': MemberSpec_('msg', 'xs:string', 0, 1, {'use': 'optional', 'name': 'msg'}),
        'Type': MemberSpec_('Type', 'Type', 0, 1, {'name': 'Type', 'ref': 'Type', 'type': 'Type'}, 4),
        'Function': MemberSpec_('Function', 'Function', 0, 1, {'name': 'Function', 'ref': 'Function', 'type': 'Function'}, 4),
        'Object': MemberSpec_('Object', 'Object', 0, 1, {'name': 'Object', 'ref': 'Object', 'type': 'Object'}, 4),
        'ObjectData': MemberSpec_('ObjectData', 'ObjectData', 0, 1, {'name': 'ObjectData', 'ref': 'ObjectData', 'type': 'ObjectData'}, 4),
        'UrlList': MemberSpec_('UrlList', 'UrlList', 0, 1, {'name': 'UrlList', 'ref': 'UrlList', 'type': 'UrlList'}, 4),
        'Result': MemberSpec_('Result', 'Result', 0, 1, {'name': 'Result', 'ref': 'Result', 'type': 'Result'}, 4),
        'Challenge': MemberSpec_('Challenge', 'Challenge', 0, 1, {'name': 'Challenge', 'ref': 'Challenge', 'type': 'Challenge'}, 4),
        'Capabilities': MemberSpec_('Capabilities', 'Capabilities', 0, 1, {'name': 'Capabilities', 'ref': 'Capabilities', 'type': 'Capabilities'}, 4),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = None
    ...
    def set_ObjectData(self, ObjectData):
        self.ObjectData = ObjectData
    ObjectDataProp = property(get_ObjectData, set_ObjectData)
    def get_UrlList(self):
        return self.UrlList
    def set_UrlList(self, UrlList):
        self.UrlList = UrlList
    UrlListProp = property(get_UrlList, set_UrlList)
    def get_Result(self):
        return self.Result
    ...
    def set_Challenge(self, Challenge):
        self.Challenge = Challenge
    ChallengeProp = property(get_Challenge, set_Challenge)
    ...
    def to_etree(self, parent_element=None, name_='Rsp', mapping_=None, reverse_mapping_=None, nsmap_=None):
        if parent_element is None:
            element = etree_.Element('{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        else:
            element = etree_.SubElement(parent_element, '{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        ...
        if self.Type is not None:
            Type_ = self.Type
            Type_.to_etree(element, name_='Type', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        if self.Function is not None:
            Function_ = self.Function
            Function_.to_etree(element, name_='Function', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        if self.Object is not None:
            Object_ = self.Object
            Object_.to_etree(element, name_='Object', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        if self.ObjectData is not None:
            ObjectData_ = self.ObjectData
            ObjectData_.to_etree(element, name_='ObjectData', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        if self.UrlList is not None:
            UrlList_ = self.UrlList
            UrlList_.to_etree(element, name_='UrlList', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        if self.Result is not None:
            Result_ = self.Result
            Result_.to_etree(element, name_='Result', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        if self.Challenge is not None:
            Challenge_ = self.Challenge
            Challenge_.to_etree(element, name_='Challenge', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        if self.Capabilities is not None:
            Capabilities_ = self.Capabilities
            Capabilities_.to_etree(element, name_='Capabilities', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        if mapping_ is not None:
            mapping_[id(self)] = element
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
        return element
    def exportLiteral(self, outfile, level, name_='Rsp'):
        level += 1
        already_processed = set()
        self._exportLiteralAttributes(outfile, level, already_processed, name_)
        if self._hasContent():
    ...
    def _exportLiteralChildren(self, outfile, level, name_):
        if self.Type is not None:
            showIndent(outfile, level)
            outfile.write('Type=model_.Type(\n')
            self.Type.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Function is not None:
            showIndent(outfile, level)
        ...
        if self.ObjectData is not None:
            showIndent(outfile, level)
            outfile.write('ObjectData=model_.ObjectData(\n')
            self.ObjectData.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.UrlList is not None:
            showIndent(outfile, level)
            outfile.write('UrlList=model_.UrlList(\n')
            self.UrlList.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Result is not None:
            showIndent(outfile, level)
            outfile.write('Result=model_.Result(\n')
            self.Result.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Challenge is not None:
            showIndent(outfile, level)
            outfile.write('Challenge=model_.Challenge(\n')
            self.Challenge.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Capabilities is not None:
            showIndent(outfile, level)
            outfile.write('Capabilities=model_.Capabilities(\n')
            self.Capabilities.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
...
class Capabilities(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'service': MemberSpec_('service', 'xs:string', 0, 0, {'use': 'required', 'name': 'service'}),
        'description': MemberSpec_('description', 'xs:string', 0, 1, {'use': 'optional', 'name': 'description'}),
        'version': MemberSpec_('version', 'versionType', 0, 1, {'use': 'optional', 'name': 'version'}),
        'Supports': MemberSpec_('Supports', 'Supports', 0, 0, {'name': 'Supports', 'ref': 'Supports', 'type': 'Supports'}, None),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = None
    ...
    def set_Supports(self, Supports):
        self.Supports = Supports
    SupportsProp = property(get_Supports, set_Supports)
    ...
    def to_etree(self, parent_element=None, name_='Capabilities', mapping_=None, reverse_mapping_=None, nsmap_=None):
        if parent_element is None:
            element = etree_.Element('{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        else:
            element = etree_.SubElement(parent_element, '{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        if self.service is not None:
            element.set('service', self.gds_format_string(self.service))
        ...
        if self.Supports is not None:
            Supports_ = self.Supports
            Supports_.to_etree(element, name_='Supports', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        if mapping_ is not None:
            mapping_[id(self)] = element
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
    ...
    def _exportLiteralChildren(self, outfile, level, name_):
        if self.Supports is not None:
            showIndent(outfile, level)
            outfile.write('Supports=model_.Supports(\n')
            self.Supports.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
...
class Supports(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'protocol': MemberSpec_('protocol', 'protocolType', 0, 0, {'use': 'required', 'name': 'protocol'}),
        'interface': MemberSpec_('interface', 'xs:boolean', 0, 1, {'use': 'optional', 'name': 'interface'}),
        'authenticate': MemberSpec_('authenticate', 'xs:boolean', 0, 1, {'use': 'optional', 'name': 'authenticate'}),
        'heartbeat': MemberSpec_('heartbeat', 'xs:boolean', 0, 1, {'use': 'optional', 'name': 'heartbeat'}),
        'datTimeStamp': MemberSpec_('datTimeStamp', 'xs:boolean', 0, 1, {'use': 'optional', 'name': 'datTimeStamp'}),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = None
    ...
    datTimeStampProp = property(get_datTimeStamp, set_datTimeStamp)
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='Supports', fromsubclass_=False, pretty_print=True):
        pass
    def to_etree(self, parent_element=None, name_='Supports', mapping_=None, reverse_mapping_=None, nsmap_=None):
        if parent_element is None:
            element = etree_.Element('{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        else:
            element = etree_.SubElement(parent_element, '{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        if self.protocol is not None:
            element.set('protocol', self.gds_format_string(self.protocol))
        if self.interface is not None:
            element.set('interface', self.gds_format_boolean(self.interface))
        if self.authenticate is not None:
            element.set('authenticate', self.gds_format_boolean(self.authenticate))
        if self.heartbeat is not None:
            element.set('heartbeat', self.gds_format_boolean(self.heartbeat))
        if self.datTimeStamp is not None:
            element.set('datTimeStamp', self.gds_format_boolean(self.datTimeStamp))
        if mapping_ is not None:
            mapping_[id(self)] = element
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
        return element
    def exportLiteral(self, outfile, level, name_='Supports'):
        level += 1
        already_processed = set()
        self._exportLiteralAttributes(outfile, level, already_processed, name_)
        if self._hasContent():
    ...
    def _exportLiteralAttributes(self, outfile, level, already_processed, name_):
        ...
        if self.authenticate is not None and 'authenticate' not in already_processed:
            already_processed.add('authenticate')
            showIndent(outfile, level)
            outfile.write('authenticate=%s,\n' % (self.authenticate,))
        if self.heartbeat is not None and 'heartbeat' not in already_processed:
            already_processed.add('heartbeat')
            showIndent(outfile, level)
            outfile.write('heartbeat=%s,\n' % (self.heartbeat,))
        if self.datTimeStamp is not None and 'datTimeStamp' not in already_processed:
            already_processed.add('datTimeStamp')
            showIndent(outfile, level)
            outfile.write('datTimeStamp=%s,\n' % (self.datTimeStamp,))
    def _exportLiteralChildren(self, outfile, level, name_):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
...
class Challenge(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'nonce': MemberSpec_('nonce', 'xs:string', 0, 1, {'use': 'optional', 'name': 'nonce'}),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = None
    ...
    def set_nonce(self, nonce):
        self.nonce = nonce
    nonceProp = property(get_nonce, set_nonce)
    def _hasContent(self):
        if (
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='Challenge', fromsubclass_=False, pretty_print=True):
        pass
    def to_etree(self, parent_element=None, name_='Challenge', mapping_=None, reverse_mapping_=None, nsmap_=None):
        if parent_element is None:
            element = etree_.Element('{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        else:
            element = etree_.SubElement(parent_element, '{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        if self.nonce is not None:
            element.set('nonce', self.gds_format_string(self.nonce))
        if mapping_ is not None:
            mapping_[id(self)] = element
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
        return element
    def exportLiteral(self, outfile, level, name_='Challenge'):
        level += 1
        already_processed = set()
        self._exportLiteralAttributes(outfile, level, already_processed, name_)
        if self._hasContent():
            self._exportLiteralChildren(outfile, level, name_)
    def _exportLiteralAttributes(self, outfile, level, already_processed, name_):
        if self.nonce is not None and 'nonce' not in already_processed:
            already_processed.add('nonce')
            showIndent(outfile, level)
            outfile.write('nonce="%s",\n' % (self.nonce,))
    def _exportLiteralChildren(self, outfile, level, name_):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
...
class UrlList(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'Match': MemberSpec_('Match', 'Match', 1, 1, {'maxOccurs': 'unbounded', 'minOccurs': '0', 'name': 'Match', 'ref': 'Match', 'type': 'Match'}, None),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = None
    ...
    MatchProp = property(get_Match, set_Match)
    def _hasContent(self):
        if (
            self.Match
        ):
    ...
    def to_etree(self, parent_element=None, name_='UrlList', mapping_=None, reverse_mapping_=None, nsmap_=None):
        if parent_element is None:
            element = etree_.Element('{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        else:
            element = etree_.SubElement(parent_element, '{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        for Match_ in self.Match:
            Match_.to_etree(element, name_='Match', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        if mapping_ is not None:
            mapping_[id(self)] = element
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
        return element
    def exportLiteral(self, outfile, level, name_='UrlList'):
        level += 1
        already_processed = set()
        self._exportLiteralAttributes(outfile, level, already_processed, name_)
        if self._hasContent():
    ...
    def _exportLiteralChildren(self, outfile, level, name_):
        ...
        for Match_ in self.Match:
            showIndent(outfile, level)
            outfile.write('model_.Match(\n')
            Match_.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class Match(GeneratedsSuper):
    ...
    member_data_items_ = {
        'url': MemberSpec_('url', 'nameType', 0, 0, {'use': 'required', 'name': 'url'}),
        'type_': MemberSpec_('type_', 'typeType', 0, 1, {'use': 'optional', 'name': 'type_'}),
        'isSubscribed': MemberSpec_('isSubscribed', 'xs:boolean', 0, 1, {'use': 'optional', 'name': 'isSubscribed'}),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = None
    ...
    isSubscribedProp = property(get_isSubscribed, set_isSubscribed)
    def validate_nameType(self, value):
        # Validate type nameType, a restriction on xs:token.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='Match', fromsubclass_=False, pretty_print=True):
        pass
    def to_etree(self, parent_element=None, name_='Match', mapping_=None, reverse_mapping_=None, nsmap_=None):
        if parent_element is None:
            element = etree_.Element('{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        else:
            element = etree_.SubElement(parent_element, '{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        ...
        if self.isSubscribed is not None:
            element.set('isSubscribed', self.gds_format_boolean(self.isSubscribed))
        if mapping_ is not None:
            mapping_[id(self)] = element
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
        return element
    def exportLiteral(self, outfile, level, name_='Match'):
        level += 1
        already_processed = set()
        self._exportLiteralAttributes(outfile, level, already_processed, name_)
        if self._hasContent():
    ...
    def _exportLiteralAttributes(self, outfile, level, already_processed, name_):
        ...
        if self.isSubscribed is not None and 'isSubscribed' not in already_processed:
            already_processed.add('isSubscribed')
            showIndent(outfile, level)
            outfile.write('isSubscribed=%s,\n' % (self.isSubscribed,))
    def _exportLiteralChildren(self, outfile, level, name_):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
...
class baseValueType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'name': MemberSpec_('name', 'nameType', 0, 0, {'use': 'required', 'name': 'name'}),
        'state': MemberSpec_('state', 'stateType', 0, 1, {'use': 'optional', 'name': 'state'}),
        'msg': MemberSpec_('msg', 'xs:string', 0, 1, {'use': 'optional', 'name': 'msg'}),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='baseValueType', fromsubclass_=False, pretty_print=True):
        pass
    def to_etree(self, parent_element=None, name_='baseValueType', mapping_=None, reverse_mapping_=None, nsmap_=None):
        if parent_element is None:
            element = etree_.Element('{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        else:
            element = etree_.SubElement(parent_element, '{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        ...
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
        return element
    def exportLiteral(self, outfile, level, name_='baseValueType'):
        level += 1
        already_processed = set()
        self._exportLiteralAttributes(outfile, level, already_processed, name_)
        if self._hasContent():
...
class Abs(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'val': MemberSpec_('val', 'xs:double', 0, 1, {'use': 'optional', 'name': 'val'}),
        'name': MemberSpec_('name', 'nameType', 0, 0, {'use': 'required', 'name': 'name'}),
        'state': MemberSpec_('state', 'stateType3', 0, 1, {'use': 'optional', 'name': 'state'}),
        'msg': MemberSpec_('msg', 'xs:string', 0, 1, {'use': 'optional', 'name': 'msg'}),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='Abs', fromsubclass_=False, pretty_print=True):
        pass
    def to_etree(self, parent_element=None, name_='Abs', mapping_=None, reverse_mapping_=None, nsmap_=None):
        if parent_element is None:
            element = etree_.Element('{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        else:
            element = etree_.SubElement(parent_element, '{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        if self.val is not None:
            element.set('val', self.gds_format_double(self.val))
        if self.name is not None:
            element.set('name', self.gds_format_string(self.name))
        if self.state is not None:
            element.set('state', self.gds_format_string(self.state))
        ...
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
        return element
    def exportLiteral(self, outfile, level, name_='Abs'):
        level += 1
        already_processed = set()
        self._exportLiteralAttributes(outfile, level, already_processed, name_)
        if self._hasContent():
...
class Act(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'val': MemberSpec_('val', 'xs:boolean', 0, 1, {'use': 'optional', 'name': 'val'}),
        'name': MemberSpec_('name', 'nameType', 0, 0, {'use': 'required', 'name': 'name'}),
        'state': MemberSpec_('state', 'stateType3', 0, 1, {'use': 'optional', 'name': 'state'}),
        'msg': MemberSpec_('msg', 'xs:string', 0, 1, {'use': 'optional', 'name': 'msg'}),
    }
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='Act', fromsubclass_=False, pretty_print=True):
        pass
    def to_etree(self, parent_element=None, name_='Act', mapping_=None, reverse_mapping_=None, nsmap_=None):
        if parent_element is None:
            element = etree_.Element('{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        else:
            element = etree_.SubElement(parent_element, '{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        if self.val is not None:
            element.set('val', self.gds_format_boolean(self.val))
        if self.name is not None:
            element.set('name', self.gds_format_string(self.name))
        if self.state is not None:
            element.set('state', self.gds_format_string(self.state))
        ...
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
        return element
    def exportLiteral(self, outfile, level, name_='Act'):
        level += 1
        already_processed = set()
        self._exportLiteralAttributes(outfile, level, already_processed, name_)
        if self._hasContent():
...
class Bin(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'val': MemberSpec_('val', 'xs:base64Binary', 0, 1, {'use': 'optional', 'name': 'val'}),
        'name': MemberSpec_('name', 'nameType', 0, 0, {'use': 'required', 'name': 'name'}),
        'state': MemberSpec_('state', 'stateType3', 0, 1, {'use': 'optional', 'name': 'state'}),
        'msg': MemberSpec_('msg', 'xs:string', 0, 1, {'use': 'optional', 'name': 'msg'}),
    }
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='Bin', fromsubclass_=False, pretty_print=True):
        pass
    def to_etree(self, parent_element=None, name_='Bin', mapping_=None, reverse_mapping_=None, nsmap_=None):
        if parent_element is None:
            element = etree_.Element('{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        else:
            element = etree_.SubElement(parent_element, '{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        if self.val is not None:
            element.set('val', self.val)
        if self.name is not None:
            element.set('name', self.gds_format_string(self.name))
        if self.state is not None:
            element.set('state', self.gds_format_string(self.state))
        ...
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
        return element
    def exportLiteral(self, outfile, level, name_='Bin'):
        level += 1
        already_processed = set()
        self._exportLiteralAttributes(outfile, level, already_processed, name_)
        if self._hasContent():
...
class Enm(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'val': MemberSpec_('val', 'identifierType', 0, 1, {'use': 'optional', 'name': 'val'}),
        'name': MemberSpec_('name', 'nameType', 0, 0, {'use': 'required', 'name': 'name'}),
        'state': MemberSpec_('state', 'stateType3', 0, 1, {'use': 'optional', 'name': 'state'}),
        'msg': MemberSpec_('msg', 'xs:string', 0, 1, {'use': 'optional', 'name': 'msg'}),
    }
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='Enm', fromsubclass_=False, pretty_print=True):
        pass
    def to_etree(self, parent_element=None, name_='Enm', mapping_=None, reverse_mapping_=None, nsmap_=None):
        if parent_element is None:
            element = etree_.Element('{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        else:
            element = etree_.SubElement(parent_element, '{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        if self.val is not None:
            element.set('val', self.gds_format_string(self.val))
        if self.name is not None:
            element.set('name', self.gds_format_string(self.name))
        if self.state is not None:
            element.set('state', self.gds_format_string(self.state))
        ...
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
        return element
    def exportLiteral(self, outfile, level, name_='Enm'):
        level += 1
        already_processed = set()
        self._exportLiteralAttributes(outfile, level, already_processed, name_)
        if self._hasContent():
...
class Txt(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'val': MemberSpec_('val', 'xs:string', 0, 1, {'use': 'optional', 'name': 'val'}),
        'name': MemberSpec_('name', 'nameType', 0, 0, {'use': 'required', 'name': 'name'}),
        'state': MemberSpec_('state', 'stateType3', 0, 1, {'use': 'optional', 'name': 'state'}),
        'msg': MemberSpec_('msg', 'xs:string', 0, 1, {'use': 'optional', 'name': 'msg'}),
    }
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='Txt', fromsubclass_=False, pretty_print=True):
        pass
    def to_etree(self, parent_element=None, name_='Txt', mapping_=None, reverse_mapping_=None, nsmap_=None):
        if parent_element is None:
            element = etree_.Element('{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        else:
            element = etree_.SubElement(parent_element, '{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        ...
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
        return element
    def exportLiteral(self, outfile, level, name_='Txt'):
        level += 1
        already_processed = set()
        self._exportLiteralAttributes(outfile, level, already_processed, name_)
        if self._hasContent():
...
class Rel(GeneratedsSuper):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='Rel', fromsubclass_=False, pretty_print=True):
        pass
    def to_etree(self, parent_element=None, name_='Rel', mapping_=None, reverse_mapping_=None, nsmap_=None):
        if parent_element is None:
            element = etree_.Element('{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        else:
            element = etree_.SubElement(parent_element, '{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
...
class Tim(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'val': MemberSpec_('val', 'valType', 0, 1, {'use': 'optional', 'name': 'val'}),
        'name': MemberSpec_('name', 'nameType', 0, 0, {'use': 'required', 'name': 'name'}),
        'state': MemberSpec_('state', 'stateType3', 0, 1, {'use': 'optional', 'name': 'state'}),
        'msg': MemberSpec_('msg', 'xs:string', 0, 1, {'use': 'optional', 'name': 'msg'}),
    }
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='Tim', fromsubclass_=False, pretty_print=True):
        pass
    def to_etree(self, parent_element=None, name_='Tim', mapping_=None, reverse_mapping_=None, nsmap_=None):
        if parent_element is None:
            element = etree_.Element('{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        else:
            element = etree_.SubElement(parent_element, '{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        ...
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
        return element
    def exportLiteral(self, outfile, level, name_='Tim'):
        level += 1
        already_processed = set()
        self._exportLiteralAttributes(outfile, level, already_processed, name_)
        if self._hasContent():
...
class List(GeneratedsSuper):
    ...
    member_data_items_ = {
        ...
        'state': MemberSpec_('state', 'stateType3', 0, 1, {'use': 'optional', 'name': 'state'}),
        'msg': MemberSpec_('msg', 'xs:string', 0, 1, {'use': 'optional', 'name': 'msg'}),
        'Elem': MemberSpec_('Elem', 'Elem', 1, 1, {'maxOccurs': 'unbounded', 'minOccurs': '0', 'name': 'Elem', 'ref': 'Elem', 'type': 'Elem'}, None),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = None
    ...
    ElemProp = property(get_Elem, set_Elem)
    def get_name(self):
        return self.name
    def set_name(self, name):
        self.name = name
    ...
    def to_etree(self, parent_element=None, name_='List', mapping_=None, reverse_mapping_=None, nsmap_=None):
        if parent_element is None:
            element = etree_.Element('{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        else:
            element = etree_.SubElement(parent_element, '{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        ...
        if self.msg is not None:
            element.set('msg', self.gds_format_string(self.msg))
        for Elem_ in self.Elem:
            Elem_.to_etree(element, name_='Elem', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        if mapping_ is not None:
            mapping_[id(self)] = element
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
    ...
    def _exportLiteralChildren(self, outfile, level, name_):
        ...
        for Elem_ in self.Elem:
            showIndent(outfile, level)
            outfile.write('model_.Elem(\n')
            Elem_.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class basicElements(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'Abs': MemberSpec_('Abs', 'Abs', 1, 1, {'name': 'Abs', 'ref': 'Abs', 'type': 'Abs'}, 5),
        'Act': MemberSpec_('Act', 'Act', 1, 1, {'name': 'Act', 'ref': 'Act', 'type': 'Act'}, 5),
        'Alt': MemberSpec_('Alt', 'Alt', 1, 1, {'name': 'Alt', 'ref': 'Alt', 'type': 'Alt'}, 5),
        'Bin': MemberSpec_('Bin', 'Bin', 1, 1, {'name': 'Bin', 'ref': 'Bin', 'type': 'Bin'}, 5),
        'Enm': MemberSpec_('Enm', 'Enm', 1, 1, {'name': 'Enm', 'ref': 'Enm', 'type': 'Enm'}, 5),
        'Txt': MemberSpec_('Txt', 'Txt', 1, 1, {'name': 'Txt', 'ref': 'Txt', 'type': 'Txt'}, 5),
        'Rel': MemberSpec_('Rel', 'Rel', 1, 1, {'name': 'Rel', 'ref': 'Rel', 'type': 'Rel'}, 5),
        'Tim': MemberSpec_('Tim', 'Tim', 1, 1, {'name': 'Tim', 'ref': 'Tim', 'type': 'Tim'}, 5),
        'List': MemberSpec_('List', 'List', 1, 1, {'name': 'List', 'ref': 'List', 'type': 'List'}, 5),
        'Obj': MemberSpec_('Obj', 'Obj', 1, 1, {'name': 'Obj', 'ref': 'Obj', 'type': 'Obj'}, 5),
    }
    ...
    AbsProp = property(get_Abs, set_Abs)
    def get_Act(self):
        return self.Act
    ...
    ActProp = property(get_Act, set_Act)
    def get_Alt(self):
        return self.Alt
    ...
    BinProp = property(get_Bin, set_Bin)
    def get_Enm(self):
        return self.Enm
    ...
    EnmProp = property(get_Enm, set_Enm)
    def get_Txt(self):
        return self.Txt
    ...
    TxtProp = property(get_Txt, set_Txt)
    def get_Rel(self):
        return self.Rel
    ...
    TimProp = property(get_Tim, set_Tim)
    def get_List(self):
        return self.List
    ...
    ListProp = property(get_List, set_List)
    def get_Obj(self):
        return self.Obj
    ...
    ObjProp = property(get_Obj, set_Obj)
    ...
    def to_etree(self, parent_element=None, name_='basicElements', mapping_=None, reverse_mapping_=None, nsmap_=None):
        if parent_element is None:
            element = etree_.Element('{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        else:
            element = etree_.SubElement(parent_element, '{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        ...
        for Abs_ in self.Abs:
            Abs_.to_etree(element, name_='Abs', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        for Act_ in self.Act:
            Act_.to_etree(element, name_='Act', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        for Alt_ in self.Alt:
            Alt_.to_etree(element, name_='Alt', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        for Bin_ in self.Bin:
            Bin_.to_etree(element, name_='Bin', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        for Enm_ in self.Enm:
            Enm_.to_etree(element, name_='Enm', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        for Txt_ in self.Txt:
            Txt_.to_etree(element, name_='Txt', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        for Rel_ in self.Rel:
            Rel_.to_etree(element, name_='Rel', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        for Tim_ in self.Tim:
            Tim_.to_etree(element, name_='Tim', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        for List_ in self.List:
            List_.to_etree(element, name_='List', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        for Obj_ in self.Obj:
            Obj_.to_etree(element, name_='Obj', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        if mapping_ is not None:
            mapping_[id(self)] = element
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
        return element
    def exportLiteral(self, outfile, level, name_='basicElements'):
        level += 1
        already_processed = set()
        self._exportLiteralAttributes(outfile, level, already_processed, name_)
        if self._hasContent():
    ...
    def _exportLiteralChildren(self, outfile, level, name_):
        ...
        for Abs_ in self.Abs:
            showIndent(outfile, level)
            outfile.write('model_.Abs(\n')
            Abs_.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        ...
        for Act_ in self.Act:
            showIndent(outfile, level)
            outfile.write('model_.Act(\n')
            Act_.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        ...
        for Alt_ in self.Alt:
            showIndent(outfile, level)
            outfile.write('model_.Alt(\n')
            Alt_.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        ...
        for Bin_ in self.Bin:
            showIndent(outfile, level)
            outfile.write('model_.Bin(\n')
            Bin_.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        ...
        for Enm_ in self.Enm:
            showIndent(outfile, level)
            outfile.write('model_.Enm(\n')
            Enm_.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        ...
        for Txt_ in self.Txt:
            showIndent(outfile, level)
            outfile.write('model_.Txt(\n')
            Txt_.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        ...
        for Rel_ in self.Rel:
            showIndent(outfile, level)
            outfile.write('model_.Rel(\n')
            Rel_.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        ...
        for Tim_ in self.Tim:
            showIndent(outfile, level)
            outfile.write('model_.Tim(\n')
            Tim_.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        ...
        for List_ in self.List:
            showIndent(outfile, level)
            outfile.write('model_.List(\n')
            List_.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        ...
        for Obj_ in self.Obj:
            showIndent(outfile, level)
            outfile.write('model_.Obj(\n')
            Obj_.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class In(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'Absolute': MemberSpec_('Absolute', 'Absolute', 1, 1, {'maxOccurs': 'unbounded', 'minOccurs': '0', 'name': 'Absolute', 'ref': 'Absolute', 'type': 'Absolute'}, None),
        'Activity': MemberSpec_('Activity', 'Activity', 1, 1, {'maxOccurs': 'unbounded', 'minOccurs': '0', 'name': 'Activity', 'ref': 'Activity', 'type': 'Activity'}, None),
        'Alternative': MemberSpec_('Alternative', 'Alternative', 1, 1, {'maxOccurs': 'unbounded', 'minOccurs': '0', 'name': 'Alternative', 'ref': 'Alternative', 'type': 'Alternative'}, None),
        'Binary': MemberSpec_('Binary', 'Binary', 1, 1, {'maxOccurs': 'unbounded', 'minOccurs': '0', 'name': 'Binary', 'ref': 'Binary', 'type': 'Binary'}, None),
        'Enumeration': MemberSpec_('Enumeration', 'Enumeration', 1, 1, {'maxOccurs': 'unbounded', 'minOccurs': '0', 'name': 'Enumeration', 'ref': 'Enumeration', 'type': 'Enumeration'}, None),
        'ListEntity': MemberSpec_('ListEntity', 'ListEntity', 1, 1, {'maxOccurs': 'unbounded', 'minOccurs': '0', 'name': 'ListEntity', 'ref': 'ListEntity', 'type': 'ListEntity'}, None),
        'ObjectEntity': MemberSpec_('ObjectEntity', 'ObjectEntity', 1, 1, {'maxOccurs': 'unbounded', 'minOccurs': '0', 'name': 'ObjectEntity', 'ref': 'ObjectEntity', 'type': 'ObjectEntity'}, None),
        'Relative': MemberSpec_('Relative', 'Relative', 1, 1, {'maxOccurs': 'unbounded', 'minOccurs': '0', 'name': 'Relative', 'ref': 'Relative', 'type': 'Relative'}, None),
        'Text': MemberSpec_('Text', 'Text', 1, 1, {'maxOccurs': 'unbounded', 'minOccurs': '0', 'name': 'Text', 'ref': 'Text', 'type': 'Text'}, None),
        'Time': MemberSpec_('Time', 'Time', 1, 1, {'maxOccurs': 'unbounded', 'minOccurs': '0', 'name': 'Time', 'ref': 'Time', 'type': 'Time'}, None),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = None
    ...
    AbsoluteProp = property(get_Absolute, set_Absolute)
    ...
    ActivityProp = property(get_Activity, set_Activity)
    ...
    AlternativeProp = property(get_Alternative, set_Alternative)
    def get_Binary(self):
        return self.Binary
    ...
    ListEntityProp = property(get_ListEntity, set_ListEntity)
    ...
    ObjectEntityProp = property(get_ObjectEntity, set_ObjectEntity)
    ...
    RelativeProp = property(get_Relative, set_Relative)
    def get_Text(self):
        return self.Text
    ...
    def to_etree(self, parent_element=None, name_='In', mapping_=None, reverse_mapping_=None, nsmap_=None):
        if parent_element is None:
            element = etree_.Element('{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        else:
            element = etree_.SubElement(parent_element, '{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        for Absolute_ in self.Absolute:
            Absolute_.to_etree(element, name_='Absolute', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        for Activity_ in self.Activity:
            Activity_.to_etree(element, name_='Activity', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        for Alternative_ in self.Alternative:
            Alternative_.to_etree(element, name_='Alternative', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        for Binary_ in self.Binary:
            Binary_.to_etree(element, name_='Binary', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        for Enumeration_ in self.Enumeration:
            Enumeration_.to_etree(element, name_='Enumeration', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        for ListEntity_ in self.ListEntity:
            ListEntity_.to_etree(element, name_='ListEntity', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        for ObjectEntity_ in self.ObjectEntity:
            ObjectEntity_.to_etree(element, name_='ObjectEntity', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        for Relative_ in self.Relative:
            Relative_.to_etree(element, name_='Relative', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        for Text_ in self.Text:
            Text_.to_etree(element, name_='Text', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        for Time_ in self.Time:
        ...
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
        return element
    def exportLiteral(self, outfile, level, name_='In'):
        level += 1
        already_processed = set()
        self._exportLiteralAttributes(outfile, level, already_processed, name_)
        if self._hasContent():
    ...
    def _exportLiteralChildren(self, outfile, level, name_):
        ...
        for Absolute_ in self.Absolute:
            showIndent(outfile, level)
            outfile.write('model_.Absolute(\n')
            Absolute_.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        ...
        outfile.write('],\n')
        showIndent(outfile, level)
        outfile.write('Alternative=[\n')
        level += 1
        for Alternative_ in self.Alternative:
            showIndent(outfile, level)
            outfile.write('model_.Alternative(\n')
            Alternative_.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        ...
        for Binary_ in self.Binary:
            showIndent(outfile, level)
            outfile.write('model_.Binary(\n')
            Binary_.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        ...
        outfile.write('],\n')
        showIndent(outfile, level)
        outfile.write('ListEntity=[\n')
        level += 1
        for ListEntity_ in self.ListEntity:
            showIndent(outfile, level)
            outfile.write('model_.ListEntity(\n')
            ListEntity_.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        outfile.write('],\n')
        showIndent(outfile, level)
        outfile.write('ObjectEntity=[\n')
        level += 1
        for ObjectEntity_ in self.ObjectEntity:
            showIndent(outfile, level)
            outfile.write('model_.ObjectEntity(\n')
            ObjectEntity_.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        ...
        for Relative_ in self.Relative:
            showIndent(outfile, level)
            outfile.write('model_.Relative(\n')
            Relative_.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        ...
        for Time_ in self.Time:
            showIndent(outfile, level)
            outfile.write('model_.Time(\n')
            Time_.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class Out(GeneratedsSuper):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://exlap.de/v1/protocol" ', name_='Out', fromsubclass_=False, pretty_print=True):
        ...
        for Time_ in self.Time:
            namespaceprefix_ = self.Time_nsprefix_ + ':' if (UseCapturedNS_ and self.Time_nsprefix_) else ''
            Time_.export(outfile, level, namespaceprefix_, namespacedef_='', name_='Time', pretty_print=pretty_print)
    def to_etree(self, parent_element=None, name_='Out', mapping_=None, reverse_mapping_=None, nsmap_=None):
        if parent_element is None:
            element = etree_.Element('{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        else:
            element = etree_.SubElement(parent_element, '{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        ...
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
        return element
    def exportLiteral(self, outfile, level, name_='Out'):
        level += 1
        already_processed = set()
        self._exportLiteralAttributes(outfile, level, already_processed, name_)
        if self._hasContent():
...
class Choice(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'typeRef': MemberSpec_('typeRef', 'nameType', 0, 0, {'use': 'required', 'name': 'typeRef'}),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = None
    ...
    typeRefProp = property(get_typeRef, set_typeRef)
    def validate_nameType(self, value):
        # Validate type nameType, a restriction on xs:token.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='Choice', fromsubclass_=False, pretty_print=True):
        pass
    def to_etree(self, parent_element=None, name_='Choice', mapping_=None, reverse_mapping_=None, nsmap_=None):
        if parent_element is None:
            element = etree_.Element('{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        else:
            element = etree_.SubElement(parent_element, '{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        if self.typeRef is not None:
            element.set('typeRef', self.gds_format_string(self.typeRef))
        if mapping_ is not None:
            mapping_[id(self)] = element
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
...
class Member(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'id': MemberSpec_('id', 'identifierType', 0, 0, {'use': 'required', 'name': 'id'}),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = None
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='Member', fromsubclass_=False, pretty_print=True):
        pass
    def to_etree(self, parent_element=None, name_='Member', mapping_=None, reverse_mapping_=None, nsmap_=None):
        if parent_element is None:
            element = etree_.Element('{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        else:
            element = etree_.SubElement(parent_element, '{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
...
class basicInterfaceElementAttributes(GeneratedsSuper):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='basicInterfaceElementAttributes', fromsubclass_=False, pretty_print=True):
        pass
    def to_etree(self, parent_element=None, name_='basicInterfaceElementAttributes', mapping_=None, reverse_mapping_=None, nsmap_=None):
        if parent_element is None:
            element = etree_.Element('{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        else:
            element = etree_.SubElement(parent_element, '{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        ...
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
        return element
    def exportLiteral(self, outfile, level, name_='basicInterfaceElementAttributes'):
        level += 1
        already_processed = set()
        self._exportLiteralAttributes(outfile, level, already_processed, name_)
        if self._hasContent():
...
class basicMemberAttributes(GeneratedsSuper):
    ...
    member_data_items_ = {
        'name': MemberSpec_('name', 'nameType', 0, 0, {'use': 'required', 'name': 'name'}),
        'required': MemberSpec_('required', 'xs:boolean', 0, 1, {'use': 'optional', 'name': 'required'}),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_) + ['extensiontype_']
    subclass = None
    superclass = None
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='basicMemberAttributes', fromsubclass_=False, pretty_print=True):
        pass
    def to_etree(self, parent_element=None, name_='basicMemberAttributes', mapping_=None, reverse_mapping_=None, nsmap_=None):
        if parent_element is None:
            element = etree_.Element('{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        else:
            element = etree_.SubElement(parent_element, '{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        ...
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
        return element
    def exportLiteral(self, outfile, level, name_='basicMemberAttributes'):
        level += 1
        already_processed = set()
        self._exportLiteralAttributes(outfile, level, already_processed, name_)
        if self._hasContent():
...
class InitType(GeneratedsSuper):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='InitType', fromsubclass_=False, pretty_print=True):
        pass
    def to_etree(self, parent_element=None, name_='InitType', mapping_=None, reverse_mapping_=None, nsmap_=None):
        if parent_element is None:
            element = etree_.Element('{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        else:
            element = etree_.SubElement(parent_element, '{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        ...
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
        return element
    def exportLiteral(self, outfile, level, name_='InitType'):
        level += 1
        already_processed = set()
        self._exportLiteralAttributes(outfile, level, already_processed, name_)
        if self._hasContent():
...
class ByeType(GeneratedsSuper):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='ByeType', fromsubclass_=False, pretty_print=True):
        pass
    def to_etree(self, parent_element=None, name_='ByeType', mapping_=None, reverse_mapping_=None, nsmap_=None):
        if parent_element is None:
            element = etree_.Element('{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        else:
            element = etree_.SubElement(parent_element, '{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        ...
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
        return element
    def exportLiteral(self, outfile, level, name_='ByeType'):
        level += 1
        already_processed = set()
        self._exportLiteralAttributes(outfile, level, already_processed, name_)
        if self._hasContent():
...
class DatalossType(GeneratedsSuper):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='DatalossType', fromsubclass_=False, pretty_print=True):
        pass
    def to_etree(self, parent_element=None, name_='DatalossType', mapping_=None, reverse_mapping_=None, nsmap_=None):
        if parent_element is None:
            element = etree_.Element('{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        else:
            element = etree_.SubElement(parent_element, '{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        ...
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
        return element
    def exportLiteral(self, outfile, level, name_='DatalossType'):
        level += 1
        already_processed = set()
        self._exportLiteralAttributes(outfile, level, already_processed, name_)
        if self._hasContent():
...
class AliveType(GeneratedsSuper):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='AliveType', fromsubclass_=False, pretty_print=True):
        pass
    def to_etree(self, parent_element=None, name_='AliveType', mapping_=None, reverse_mapping_=None, nsmap_=None):
        if parent_element is None:
            element = etree_.Element('{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        else:
            element = etree_.SubElement(parent_element, '{http://exlap.de/v1/protocol}' + name_, nsmap=nsmap_)
        ...
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
        return element
    def exportLiteral(self, outfile, level, name_='AliveType'):
        level += 1
        already_processed = set()
        self._exportLiteralAttributes(outfile, level, already_processed, name_)
        if self._hasContent():
...
class ObjectEntity(basicMemberAttributes):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='ObjectEntity', fromsubclass_=False, pretty_print=True):
        ...
        pass
    def to_etree(self, parent_element=None, name_='ObjectEntity', mapping_=None, reverse_mapping_=None, nsmap_=None):
        element = super(ObjectEntity, self).to_etree(parent_element, name_, mapping_, reverse_mapping_, nsmap_)
        if self.typeRef is not None:
            element.set('typeRef', self.gds_format_string(self.typeRef))
        if mapping_ is not None:
            mapping_[id(self)] = element
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
        return element
    def exportLiteral(self, outfile, level, name_='ObjectEntity'):
        level += 1
        already_processed = set()
        self._exportLiteralAttributes(outfile, level, already_processed, name_)
        if self._hasContent():
    ...
    def _exportLiteralAttributes(self, outfile, level, already_processed, name_):
        if self.typeRef is not None and 'typeRef' not in already_processed:
            ...
            showIndent(outfile, level)
            outfile.write('typeRef="%s",\n' % (self.typeRef,))
        super(ObjectEntity, self)._exportLiteralAttributes(outfile, level, already_processed, name_)
    def _exportLiteralChildren(self, outfile, level, name_):
        super(ObjectEntity, self)._exportLiteralChildren(outfile, level, name_)
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class ListEntity(basicMemberAttributes):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='ListEntity', fromsubclass_=False, pretty_print=True):
        ...
        pass
    def to_etree(self, parent_element=None, name_='ListEntity', mapping_=None, reverse_mapping_=None, nsmap_=None):
        element = super(ListEntity, self).to_etree(parent_element, name_, mapping_, reverse_mapping_, nsmap_)
        if self.typeRef is not None:
            element.set('typeRef', self.gds_format_string(self.typeRef))
        if mapping_ is not None:
            mapping_[id(self)] = element
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
        return element
    def exportLiteral(self, outfile, level, name_='ListEntity'):
        level += 1
        already_processed = set()
        self._exportLiteralAttributes(outfile, level, already_processed, name_)
        if self._hasContent():
    ...
    def _exportLiteralAttributes(self, outfile, level, already_processed, name_):
        if self.typeRef is not None and 'typeRef' not in already_processed:
            ...
            showIndent(outfile, level)
            outfile.write('typeRef="%s",\n' % (self.typeRef,))
        super(ListEntity, self)._exportLiteralAttributes(outfile, level, already_processed, name_)
    def _exportLiteralChildren(self, outfile, level, name_):
        super(ListEntity, self)._exportLiteralChildren(outfile, level, name_)
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class Time(basicMemberAttributes):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'isLocalTime': MemberSpec_('isLocalTime', 'xs:boolean', 0, 0, {'use': 'required', 'name': 'isLocalTime'}),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = basicMemberAttributes
    ...
    isLocalTimeProp = property(get_isLocalTime, set_isLocalTime)
    def _hasContent(self):
        if (
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='Time', fromsubclass_=False, pretty_print=True):
        ...
        pass
    def to_etree(self, parent_element=None, name_='Time', mapping_=None, reverse_mapping_=None, nsmap_=None):
        element = super(Time, self).to_etree(parent_element, name_, mapping_, reverse_mapping_, nsmap_)
        if self.isLocalTime is not None:
            element.set('isLocalTime', self.gds_format_boolean(self.isLocalTime))
        if mapping_ is not None:
            mapping_[id(self)] = element
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
    ...
    def _exportLiteralAttributes(self, outfile, level, already_processed, name_):
        if self.isLocalTime is not None and 'isLocalTime' not in already_processed:
            already_processed.add('isLocalTime')
            showIndent(outfile, level)
            outfile.write('isLocalTime=%s,\n' % (self.isLocalTime,))
        super(Time, self)._exportLiteralAttributes(outfile, level, already_processed, name_)
    def _exportLiteralChildren(self, outfile, level, name_):
        super(Time, self)._exportLiteralChildren(outfile, level, name_)
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class Text(basicMemberAttributes):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'regExp': MemberSpec_('regExp', 'xs:string', 0, 1, {'use': 'optional', 'name': 'regExp'}),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = basicMemberAttributes
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='Text', fromsubclass_=False, pretty_print=True):
        ...
        pass
    def to_etree(self, parent_element=None, name_='Text', mapping_=None, reverse_mapping_=None, nsmap_=None):
        element = super(Text, self).to_etree(parent_element, name_, mapping_, reverse_mapping_, nsmap_)
        if self.regExp is not None:
            element.set('regExp', self.gds_format_string(self.regExp))
        if mapping_ is not None:
            mapping_[id(self)] = element
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
    ...
    def _exportLiteralAttributes(self, outfile, level, already_processed, name_):
        ...
        super(Text, self)._exportLiteralAttributes(outfile, level, already_processed, name_)
    def _exportLiteralChildren(self, outfile, level, name_):
        super(Text, self)._exportLiteralChildren(outfile, level, name_)
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class Relative(basicMemberAttributes):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'min': MemberSpec_('min', 'xs:double', 0, 0, {'use': 'required', 'name': 'min'}),
        'max': MemberSpec_('max', 'xs:double', 0, 0, {'use': 'required', 'name': 'max'}),
        'minLabel': MemberSpec_('minLabel', 'identifierType', 0, 0, {'use': 'required', 'name': 'minLabel'}),
        'maxLabel': MemberSpec_('maxLabel', 'identifierType', 0, 0, {'use': 'required', 'name': 'maxLabel'}),
        'resolution': MemberSpec_('resolution', 'xs:double', 0, 1, {'use': 'optional', 'name': 'resolution'}),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = basicMemberAttributes
    ...
    minLabelProp = property(get_minLabel, set_minLabel)
    def get_maxLabel(self):
        return self.maxLabel
    def set_maxLabel(self, maxLabel):
        self.maxLabel = maxLabel
    maxLabelProp = property(get_maxLabel, set_maxLabel)
    def get_resolution(self):
        return self.resolution
    def set_resolution(self, resolution):
        self.resolution = resolution
    resolutionProp = property(get_resolution, set_resolution)
    def validate_identifierType(self, value):
        # Validate type identifierType, a restriction on xs:token.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='Relative', fromsubclass_=False, pretty_print=True):
        ...
        pass
    def to_etree(self, parent_element=None, name_='Relative', mapping_=None, reverse_mapping_=None, nsmap_=None):
        element = super(Relative, self).to_etree(parent_element, name_, mapping_, reverse_mapping_, nsmap_)
        if self.min is not None:
            element.set('min', self.gds_format_double(self.min))
        if self.max is not None:
            element.set('max', self.gds_format_double(self.max))
        if self.minLabel is not None:
            element.set('minLabel', self.gds_format_string(self.minLabel))
        if self.maxLabel is not None:
            element.set('maxLabel', self.gds_format_string(self.maxLabel))
        ...
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
        return element
    def exportLiteral(self, outfile, level, name_='Relative'):
        level += 1
        already_processed = set()
        self._exportLiteralAttributes(outfile, level, already_processed, name_)
        if self._hasContent():
    ...
    def _exportLiteralAttributes(self, outfile, level, already_processed, name_):
        ...
        if self.minLabel is not None and 'minLabel' not in already_processed:
            already_processed.add('minLabel')
            showIndent(outfile, level)
            outfile.write('minLabel="%s",\n' % (self.minLabel,))
        if self.maxLabel is not None and 'maxLabel' not in already_processed:
            already_processed.add('maxLabel')
            showIndent(outfile, level)
            outfile.write('maxLabel="%s",\n' % (self.maxLabel,))
        if self.resolution is not None and 'resolution' not in already_processed:
            already_processed.add('resolution')
            showIndent(outfile, level)
            outfile.write('resolution=%e,\n' % (self.resolution,))
        super(Relative, self)._exportLiteralAttributes(outfile, level, already_processed, name_)
    def _exportLiteralChildren(self, outfile, level, name_):
        super(Relative, self)._exportLiteralChildren(outfile, level, name_)
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class Enumeration(basicMemberAttributes):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'Member': MemberSpec_('Member', 'Member', 1, 0, {'maxOccurs': 'unbounded', 'name': 'Member', 'ref': 'Member', 'type': 'Member'}, None),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = basicMemberAttributes
    ...
    def to_etree(self, parent_element=None, name_='Enumeration', mapping_=None, reverse_mapping_=None, nsmap_=None):
        element = super(Enumeration, self).to_etree(parent_element, name_, mapping_, reverse_mapping_, nsmap_)
        for Member_ in self.Member:
            Member_.to_etree(element, name_='Member', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        if mapping_ is not None:
            mapping_[id(self)] = element
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
    ...
    def exportLiteral(self, outfile, level, name_='Enumeration'):
        ...
        if self._hasContent():
            self._exportLiteralChildren(outfile, level, name_)
    def _exportLiteralAttributes(self, outfile, level, already_processed, name_):
        super(Enumeration, self)._exportLiteralAttributes(outfile, level, already_processed, name_)
    def _exportLiteralChildren(self, outfile, level, name_):
        super(Enumeration, self)._exportLiteralChildren(outfile, level, name_)
        showIndent(outfile, level)
...
class Binary(basicMemberAttributes):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'contentType': MemberSpec_('contentType', 'xs:string', 0, 0, {'use': 'required', 'name': 'contentType'}),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = basicMemberAttributes
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='Binary', fromsubclass_=False, pretty_print=True):
        ...
        pass
    def to_etree(self, parent_element=None, name_='Binary', mapping_=None, reverse_mapping_=None, nsmap_=None):
        element = super(Binary, self).to_etree(parent_element, name_, mapping_, reverse_mapping_, nsmap_)
    ...
    def _exportLiteralAttributes(self, outfile, level, already_processed, name_):
        ...
        super(Binary, self)._exportLiteralAttributes(outfile, level, already_processed, name_)
    def _exportLiteralChildren(self, outfile, level, name_):
        super(Binary, self)._exportLiteralChildren(outfile, level, name_)
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class Alternative(basicMemberAttributes):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'Choice': MemberSpec_('Choice', 'Choice', 1, 0, {'maxOccurs': 'unbounded', 'name': 'Choice', 'ref': 'Choice', 'type': 'Choice'}, None),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = basicMemberAttributes
    ...
    ChoiceProp = property(get_Choice, set_Choice)
    def _hasContent(self):
        if (
            self.Choice or
    ...
    def to_etree(self, parent_element=None, name_='Alternative', mapping_=None, reverse_mapping_=None, nsmap_=None):
        element = super(Alternative, self).to_etree(parent_element, name_, mapping_, reverse_mapping_, nsmap_)
        for Choice_ in self.Choice:
            Choice_.to_etree(element, name_='Choice', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        if mapping_ is not None:
            mapping_[id(self)] = element
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
    ...
    def exportLiteral(self, outfile, level, name_='Alternative'):
        ...
        if self._hasContent():
            self._exportLiteralChildren(outfile, level, name_)
    def _exportLiteralAttributes(self, outfile, level, already_processed, name_):
        super(Alternative, self)._exportLiteralAttributes(outfile, level, already_processed, name_)
    def _exportLiteralChildren(self, outfile, level, name_):
        super(Alternative, self)._exportLiteralChildren(outfile, level, name_)
        showIndent(outfile, level)
...
class Activity(basicMemberAttributes):
    ...
    def to_etree(self, parent_element=None, name_='Activity', mapping_=None, reverse_mapping_=None, nsmap_=None):
        element = super(Activity, self).to_etree(parent_element, name_, mapping_, reverse_mapping_, nsmap_)
        if mapping_ is not None:
            mapping_[id(self)] = element
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
    ...
    def exportLiteral(self, outfile, level, name_='Activity'):
        ...
        if self._hasContent():
            self._exportLiteralChildren(outfile, level, name_)
    def _exportLiteralAttributes(self, outfile, level, already_processed, name_):
        super(Activity, self)._exportLiteralAttributes(outfile, level, already_processed, name_)
    def _exportLiteralChildren(self, outfile, level, name_):
        super(Activity, self)._exportLiteralChildren(outfile, level, name_)
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class Absolute(basicMemberAttributes):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'unit': MemberSpec_('unit', 'xs:string', 0, 0, {'use': 'required', 'name': 'unit'}),
        'min': MemberSpec_('min', 'xs:double', 0, 1, {'use': 'optional', 'name': 'min'}),
        'max': MemberSpec_('max', 'xs:double', 0, 1, {'use': 'optional', 'name': 'max'}),
        'resolution': MemberSpec_('resolution', 'xs:double', 0, 1, {'use': 'optional', 'name': 'resolution'}),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='Absolute'):
        ...
        if self.min != -0 and 'min' not in already_processed:
            already_processed.add('min')
            outfile.write(' min="%s"' % self.gds_format_double(self.min, input_name='min'))
        if self.max != 60 and 'max' not in already_processed:
            already_processed.add('max')
            outfile.write(' max="%s"' % self.gds_format_double(self.max, input_name='max'))
        if self.resolution != 0 and 'resolution' not in already_processed:
            already_processed.add('resolution')
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='Absolute', fromsubclass_=False, pretty_print=True):
        ...
        pass
    def to_etree(self, parent_element=None, name_='Absolute', mapping_=None, reverse_mapping_=None, nsmap_=None):
        element = super(Absolute, self).to_etree(parent_element, name_, mapping_, reverse_mapping_, nsmap_)
    ...
    def _exportLiteralAttributes(self, outfile, level, already_processed, name_):
        ...
        if self.resolution is not None and 'resolution' not in already_processed:
            ...
            showIndent(outfile, level)
            outfile.write('resolution=%e,\n' % (self.resolution,))
        super(Absolute, self)._exportLiteralAttributes(outfile, level, already_processed, name_)
    def _exportLiteralChildren(self, outfile, level, name_):
        super(Absolute, self)._exportLiteralChildren(outfile, level, name_)
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class Type(basicInterfaceElementAttributes):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'Absolute': MemberSpec_('Absolute', 'Absolute', 1, 0, {'maxOccurs': 'unbounded', 'minOccurs': '1', 'name': 'Absolute', 'ref': 'Absolute', 'type': 'Absolute'}, None),
        'Activity': MemberSpec_('Activity', 'Activity', 1, 0, {'maxOccurs': 'unbounded', 'minOccurs': '1', 'name': 'Activity', 'ref': 'Activity', 'type': 'Activity'}, None),
        'Alternative': MemberSpec_('Alternative', 'Alternative', 1, 0, {'maxOccurs': 'unbounded', 'minOccurs': '1', 'name': 'Alternative', 'ref': 'Alternative', 'type': 'Alternative'}, None),
        'Binary': MemberSpec_('Binary', 'Binary', 1, 0, {'maxOccurs': 'unbounded', 'minOccurs': '1', 'name': 'Binary', 'ref': 'Binary', 'type': 'Binary'}, None),
        'Enumeration': MemberSpec_('Enumeration', 'Enumeration', 1, 0, {'maxOccurs': 'unbounded', 'minOccurs': '1', 'name': 'Enumeration', 'ref': 'Enumeration', 'type': 'Enumeration'}, None),
        'ListEntity': MemberSpec_('ListEntity', 'ListEntity', 1, 0, {'maxOccurs': 'unbounded', 'minOccurs': '1', 'name': 'ListEntity', 'ref': 'ListEntity', 'type': 'ListEntity'}, None),
        'ObjectEntity': MemberSpec_('ObjectEntity', 'ObjectEntity', 1, 0, {'maxOccurs': 'unbounded', 'minOccurs': '1', 'name': 'ObjectEntity', 'ref': 'ObjectEntity', 'type': 'ObjectEntity'}, None),
        'Relative': MemberSpec_('Relative', 'Relative', 1, 0, {'maxOccurs': 'unbounded', 'minOccurs': '1', 'name': 'Relative', 'ref': 'Relative', 'type': 'Relative'}, None),
        'Text': MemberSpec_('Text', 'Text', 1, 0, {'maxOccurs': 'unbounded', 'minOccurs': '1', 'name': 'Text', 'ref': 'Text', 'type': 'Text'}, None),
        'Time': MemberSpec_('Time', 'Time', 1, 0, {'maxOccurs': 'unbounded', 'minOccurs': '1', 'name': 'Time', 'ref': 'Time', 'type': 'Time'}, None),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://exlap.de/v1/protocol" ', name_='Type', fromsubclass_=False, pretty_print=True):
        ...
        for Time_ in self.Time:
            namespaceprefix_ = self.Time_nsprefix_ + ':' if (UseCapturedNS_ and self.Time_nsprefix_) else ''
            Time_.export(outfile, level, namespaceprefix_, namespacedef_='', name_='Time', pretty_print=pretty_print)
    def to_etree(self, parent_element=None, name_='Type', mapping_=None, reverse_mapping_=None, nsmap_=None):
        element = super(Type, self).to_etree(parent_element, name_, mapping_, reverse_mapping_, nsmap_)
        for Absolute_ in self.Absolute:
            Absolute_.to_etree(element, name_='Absolute', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        for Activity_ in self.Activity:
            Activity_.to_etree(element, name_='Activity', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
    ...
    def exportLiteral(self, outfile, level, name_='Type'):
        ...
        if self._hasContent():
            self._exportLiteralChildren(outfile, level, name_)
    def _exportLiteralAttributes(self, outfile, level, already_processed, name_):
        super(Type, self)._exportLiteralAttributes(outfile, level, already_processed, name_)
    def _exportLiteralChildren(self, outfile, level, name_):
        super(Type, self)._exportLiteralChildren(outfile, level, name_)
        showIndent(outfile, level)
        outfile.write('Absolute=[\n')
        level += 1
        for Absolute_ in self.Absolute:
...
class Function(basicInterfaceElementAttributes):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'required': MemberSpec_('required', 'xs:string', 0, 1, {'use': 'optional', 'name': 'required'}),
        'In': MemberSpec_('In', 'In', 0, 0, {'name': 'In', 'ref': 'In', 'type': 'In'}, None),
        'Out': MemberSpec_('Out', 'Out', 0, 0, {'name': 'Out', 'ref': 'Out', 'type': 'Out'}, None),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = basicInterfaceElementAttributes
    ...
    def set_In(self, In):
        self.In = In
    InProp = property(get_In, set_In)
    def get_Out(self):
        return self.Out
    def set_Out(self, Out):
        self.Out = Out
    OutProp = property(get_Out, set_Out)
    def get_required(self):
        return self.required
    def set_required(self, required):
        self.required = required
    ...
    def to_etree(self, parent_element=None, name_='Function', mapping_=None, reverse_mapping_=None, nsmap_=None):
        element = super(Function, self).to_etree(parent_element, name_, mapping_, reverse_mapping_, nsmap_)
        if self.required is not None:
            element.set('required', self.gds_format_string(self.required))
        if self.In is not None:
            In_ = self.In
            In_.to_etree(element, name_='In', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        if self.Out is not None:
            Out_ = self.Out
            Out_.to_etree(element, name_='Out', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
        if mapping_ is not None:
            mapping_[id(self)] = element
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
    ...
    def _exportLiteralAttributes(self, outfile, level, already_processed, name_):
        if self.required is not None and 'required' not in already_processed:
            ...
            showIndent(outfile, level)
            outfile.write('required="%s",\n' % (self.required,))
        super(Function, self)._exportLiteralAttributes(outfile, level, already_processed, name_)
    def _exportLiteralChildren(self, outfile, level, name_):
        super(Function, self)._exportLiteralChildren(outfile, level, name_)
        if self.In is not None:
            showIndent(outfile, level)
            outfile.write('In=model_.In(\n')
            self.In.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Out is not None:
            showIndent(outfile, level)
            outfile.write('Out=model_.Out(\n')
            self.Out.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
...
class Object(basicInterfaceElementAttributes):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'context': MemberSpec_('context', 'contextType', 0, 1, {'use': 'optional', 'name': 'context'}),
        'characteristic': MemberSpec_('characteristic', 'characteristicType', 0, 0, {'use': 'required', 'name': 'characteristic'}),
        'interval': MemberSpec_('interval', 'xs:nonNegativeInteger', 0, 1, {'use': 'optional', 'name': 'interval'}),
        'required': MemberSpec_('required', 'xs:string', 0, 1, {'use': 'optional', 'name': 'required'}),
        'Absolute': MemberSpec_('Absolute', 'Absolute', 1, 0, {'maxOccurs': 'unbounded', 'minOccurs': '1', 'name': 'Absolute', 'ref': 'Absolute', 'type': 'Absolute'}, None),
        'Activity': MemberSpec_('Activity', 'Activity', 1, 0, {'maxOccurs': 'unbounded', 'minOccurs': '1', 'name': 'Activity', 'ref': 'Activity', 'type': 'Activity'}, None),
        'Alternative': MemberSpec_('Alternative', 'Alternative', 1, 0, {'maxOccurs': 'unbounded', 'minOccurs': '1', 'name': 'Alternative', 'ref': 'Alternative', 'type': 'Alternative'}, None),
    ...
    characteristicProp = property(get_characteristic, set_characteristic)
    def get_interval(self):
        return self.interval
    def set_interval(self, interval):
        self.interval = interval
    intervalProp = property(get_interval, set_interval)
    def get_required(self):
        return self.required
    def set_required(self, required):
        self.required = required
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://exlap.de/v1/protocol" ', name_='Object', fromsubclass_=False, pretty_print=True):
        ...
        for Time_ in self.Time:
            namespaceprefix_ = self.Time_nsprefix_ + ':' if (UseCapturedNS_ and self.Time_nsprefix_) else ''
            Time_.export(outfile, level, namespaceprefix_, namespacedef_='', name_='Time', pretty_print=pretty_print)
    def to_etree(self, parent_element=None, name_='Object', mapping_=None, reverse_mapping_=None, nsmap_=None):
        element = super(Object, self).to_etree(parent_element, name_, mapping_, reverse_mapping_, nsmap_)
        if self.context is not None:
            element.set('context', self.gds_format_string(self.context))
        if self.characteristic is not None:
            element.set('characteristic', self.gds_format_string(self.characteristic))
        if self.interval is not None:
            element.set('interval', self.gds_format_integer(self.interval))
        if self.required is not None:
            element.set('required', self.gds_format_string(self.required))
        for Absolute_ in self.Absolute:
            Absolute_.to_etree(element, name_='Absolute', mapping_=mapping_, reverse_mapping_=reverse_mapping_, nsmap_=nsmap_)
    ...
    def _exportLiteralAttributes(self, outfile, level, already_processed, name_):
        ...
        if self.required is not None and 'required' not in already_processed:
            ...
            showIndent(outfile, level)
            outfile.write('required="%s",\n' % (self.required,))
        super(Object, self)._exportLiteralAttributes(outfile, level, already_processed, name_)
    def _exportLiteralChildren(self, outfile, level, name_):
        super(Object, self)._exportLiteralChildren(outfile, level, name_)
        showIndent(outfile, level)
        outfile.write('Absolute=[\n')
        level += 1
        for Absolute_ in self.Absolute:
...
class Obj(basicElements):
    ...
    def to_etree(self, parent_element=None, name_='Obj', mapping_=None, reverse_mapping_=None, nsmap_=None):
        element = super(Obj, self).to_etree(parent_element, name_, mapping_, reverse_mapping_, nsmap_)
        if self.name is not None:
            element.set('name', self.gds_format_string(self.name))
        if self.state is not None:
            element.set('state', self.gds_format_string(self.state))
        ...
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
        return element
    def exportLiteral(self, outfile, level, name_='Obj'):
        level += 1
        already_processed = set()
        self._exportLiteralAttributes(outfile, level, already_processed, name_)
        if self._hasContent():
    ...
    def _exportLiteralAttributes(self, outfile, level, already_processed, name_):
        ...
        if self.msg is not None and 'msg' not in already_processed:
            ...
            showIndent(outfile, level)
            outfile.write('msg="%s",\n' % (self.msg,))
        super(Obj, self)._exportLiteralAttributes(outfile, level, already_processed, name_)
    def _exportLiteralChildren(self, outfile, level, name_):
        super(Obj, self)._exportLiteralChildren(outfile, level, name_)
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
...
class Elem(basicElements):
    ...
    def to_etree(self, parent_element=None, name_='Elem', mapping_=None, reverse_mapping_=None, nsmap_=None):
        element = super(Elem, self).to_etree(parent_element, name_, mapping_, reverse_mapping_, nsmap_)
        if mapping_ is not None:
            mapping_[id(self)] = element
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
        return element
    def exportLiteral(self, outfile, level, name_='Elem'):
        level += 1
        already_processed = set()
        self._exportLiteralAttributes(outfile, level, already_processed, name_)
        if self._hasContent():
            self._exportLiteralChildren(outfile, level, name_)
    def _exportLiteralAttributes(self, outfile, level, already_processed, name_):
        super(Elem, self)._exportLiteralAttributes(outfile, level, already_processed, name_)
    def _exportLiteralChildren(self, outfile, level, name_):
        super(Elem, self)._exportLiteralChildren(outfile, level, name_)
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
...
class Alt(basicElements):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'type_': MemberSpec_('type_', 'nameType', 0, 0, {'use': 'required', 'name': 'type_'}),
        'name': MemberSpec_('name', 'nameType', 0, 0, {'use': 'required', 'name': 'name'}),
        'state': MemberSpec_('state', 'stateType3', 0, 1, {'use': 'optional', 'name': 'state'}),
        'msg': MemberSpec_('msg', 'xs:string', 0, 1, {'use': 'optional', 'name': 'msg'}),
    }
    ...
    def to_etree(self, parent_element=None, name_='Alt', mapping_=None, reverse_mapping_=None, nsmap_=None):
        element = super(Alt, self).to_etree(parent_element, name_, mapping_, reverse_mapping_, nsmap_)
        if self.type_ is not None:
            element.set('type', self.gds_format_string(self.type_))
        if self.name is not None:
            element.set('name', self.gds_format_string(self.name))
        ...
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
        return element
    def exportLiteral(self, outfile, level, name_='Alt'):
        level += 1
        already_processed = set()
        self._exportLiteralAttributes(outfile, level, already_processed, name_)
        if self._hasContent():
    ...
    def _exportLiteralAttributes(self, outfile, level, already_processed, name_):
        ...
        if self.msg is not None and 'msg' not in already_processed:
            ...
            showIndent(outfile, level)
            outfile.write('msg="%s",\n' % (self.msg,))
        super(Alt, self)._exportLiteralAttributes(outfile, level, already_processed, name_)
    def _exportLiteralChildren(self, outfile, level, name_):
        super(Alt, self)._exportLiteralChildren(outfile, level, name_)
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
...
class Result(basicElements):
    ...
    def to_etree(self, parent_element=None, name_='Result', mapping_=None, reverse_mapping_=None, nsmap_=None):
        element = super(Result, self).to_etree(parent_element, name_, mapping_, reverse_mapping_, nsmap_)
        if self.url is not None:
            element.set('url', self.gds_format_string(self.url))
        if mapping_ is not None:
            mapping_[id(self)] = element
    ...
    def _exportLiteralAttributes(self, outfile, level, already_processed, name_):
        if self.url is not None and 'url' not in already_processed:
            ...
            showIndent(outfile, level)
            outfile.write('url="%s",\n' % (self.url,))
        super(Result, self)._exportLiteralAttributes(outfile, level, already_processed, name_)
    def _exportLiteralChildren(self, outfile, level, name_):
        super(Result, self)._exportLiteralChildren(outfile, level, name_)
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
...
class ObjectData(basicElements):
    ...
    def to_etree(self, parent_element=None, name_='ObjectData', mapping_=None, reverse_mapping_=None, nsmap_=None):
        element = super(ObjectData, self).to_etree(parent_element, name_, mapping_, reverse_mapping_, nsmap_)
        if self.url is not None:
            element.set('url', self.gds_format_string(self.url))
        if mapping_ is not None:
            mapping_[id(self)] = element
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
        return element
    def exportLiteral(self, outfile, level, name_='ObjectData'):
        level += 1
        already_processed = set()
        self._exportLiteralAttributes(outfile, level, already_processed, name_)
        if self._hasContent():
    ...
    def _exportLiteralAttributes(self, outfile, level, already_processed, name_):
        if self.url is not None and 'url' not in already_processed:
            ...
            showIndent(outfile, level)
            outfile.write('url="%s",\n' % (self.url,))
        super(ObjectData, self)._exportLiteralAttributes(outfile, level, already_processed, name_)
    def _exportLiteralChildren(self, outfile, level, name_):
        super(ObjectData, self)._exportLiteralChildren(outfile, level, name_)
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
...
class Call(basicElements):
    ...
    def to_etree(self, parent_element=None, name_='Call', mapping_=None, reverse_mapping_=None, nsmap_=None):
        element = super(Call, self).to_etree(parent_element, name_, mapping_, reverse_mapping_, nsmap_)
        if self.url is not None:
            element.set('url', self.gds_format_string(self.url))
        if mapping_ is not None:
            mapping_[id(self)] = element
    ...
    def _exportLiteralAttributes(self, outfile, level, already_processed, name_):
        if self.url is not None and 'url' not in already_processed:
            ...
            showIndent(outfile, level)
            outfile.write('url="%s",\n' % (self.url,))
        super(Call, self)._exportLiteralAttributes(outfile, level, already_processed, name_)
    def _exportLiteralChildren(self, outfile, level, name_):
        super(Call, self)._exportLiteralChildren(outfile, level, name_)
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
...
class Dat(basicElements):
    ...
    member_data_items_ = {
        'url': MemberSpec_('url', 'nameType', 0, 0, {'use': 'required', 'name': 'url'}),
        'timeStamp': MemberSpec_('timeStamp', 'xs:dateTime', 0, 1, {'use': 'optional', 'name': 'timeStamp'}),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = basicElements
    ...
    def to_etree(self, parent_element=None, name_='Dat', mapping_=None, reverse_mapping_=None, nsmap_=None):
        element = super(Dat, self).to_etree(parent_element, name_, mapping_, reverse_mapping_, nsmap_)
        if self.url is not None:
            element.set('url', self.gds_format_string(self.url))
        if self.timeStamp is not None:
            element.set('timeStamp', self.gds_format_datetime(self.timeStamp))
        if mapping_ is not None:
            mapping_[id(self)] = element
        if reverse_mapping_ is not None:
            reverse_mapping_[element] = self
        return element
    def exportLiteral(self, outfile, level, name_='Dat'):
        level += 1
        already_processed = set()
        self._exportLiteralAttributes(outfile, level, already_processed, name_)
        if self._hasContent():
    ...
    def _exportLiteralAttributes(self, outfile, level, already_processed, name_):
        ...
        super(Dat, self)._exportLiteralAttributes(outfile, level, already_processed, name_)
    def _exportLiteralChildren(self, outfile, level, name_):
        super(Dat, self)._exportLiteralChildren(outfile, level, name_)
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from exlap_v2 import *\n\n')
        sys.stdout.write('import exlap_v2 as model_\n\n')
